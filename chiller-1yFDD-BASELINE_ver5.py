...
def train_NN(data_ready, n_epoch):
    ...
    Y_var = data_train[:,(n_input)]/1000000             ## MEGA JULE
...
records_save_baseline_RMSE(RMSE_mat)
records_save_baseline(RMSLE_mat)

#######################################################
#%% Diagonal element

RMSE_mat = np.loadtxt("RMSE_matrix_baseline_0907_1739.csv",delimiter=",",skiprows=1)
RMSLE_mat = np.loadtxt("RMSLE_matrix_baseline_0907_1739.csv",delimiter=",",skiprows=1)
